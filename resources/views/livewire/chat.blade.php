<div wire:poll>
    <div class="container">
        <h3 class=" text-center">
            ...
            @if (auth()->user()->email == 'mohamedkaramm@gmail.com')
                <a class="btn btn-primary" href="{{ Url('delete_chat') }}">Delete Meesage</a>
            @endif
            Chat App
        </h3>
        <div class="messaging">
                ...
                <div class="mesgs">
                    <div id="chat" class="msg_history">
                        @forelse ($messages as $message)
                            ...
                            @endif
                        @empty
                            <h5 style="text-align: center;color:red">No Found Message</h5>
                        @endforelse
                    ...
                    <div class="type_msg">
                        <div class="input_msg_write">
                            <form wire:submit.prevent="sendMessage">
                                ...
                                <button class="msg_send_btn" type="submit">Send Message</button>
                            </form>
                        </div>
                    </div>
